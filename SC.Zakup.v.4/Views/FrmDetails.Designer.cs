namespace SC.Zakup.Views
{
	partial class FrmDetails
	{
		...
		private void InitializeComponent()
		{
			...
			this.gcDetail.Location = new System.Drawing.Point(0, 215);
			this.gcDetail.MainView = this.gvDetail;
			this.gcDetail.Margin = new System.Windows.Forms.Padding(4);
			this.gcDetail.MenuManager = this.ribbon;
			this.gcDetail.Name = "gcDetail";
			this.gcDetail.Size = new System.Drawing.Size(1079, 346);
			...
			// 
			this.cDetailBindingSource.DataSource = typeof(SC.Common.Model.CDetail);
			// 
			// gvDetail
			// 
			...
			this.colNoUsed.MinWidth = 25;
			this.colNoUsed.Name = "colNoUsed";
			this.colNoUsed.Visible = true;
			this.colNoUsed.VisibleIndex = 3;
			this.colNoUsed.Width = 94;
			// 
			// coldtc
			// 
			...
			this.coldtc.VisibleIndex = 4;
			this.coldtc.Width = 94;
			// 
			// FrmDetails
			// 
