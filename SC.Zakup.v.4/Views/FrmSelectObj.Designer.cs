namespace SC.Budget.Views
{
    partial class FrmSelectObj
    {
        ...
        private void InitializeComponent()
        {
			...
			this.pnMenu = new DevExpress.Utils.Layout.TablePanel();
			...
			// pnMenu
			// 
			this.pnMenu.Columns.AddRange(new DevExpress.Utils.Layout.TablePanelColumn[] {
            new DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 50F),
            new DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 50F),
            new DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 50F),
            new DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 50F)});
			this.pnMenu.Controls.Add(this.btIsSklad);
			this.pnMenu.Controls.Add(this.btIsNoMyOnly);
			this.pnMenu.Controls.Add(this.btIsAll);
			this.pnMenu.Controls.Add(this.btIsMyOnly);
			this.pnMenu.Dock = System.Windows.Forms.DockStyle.Top;
			this.pnMenu.Location = new System.Drawing.Point(0, 0);
			this.pnMenu.Name = "pnMenu";
			this.pnMenu.Padding = new System.Windows.Forms.Padding(5);
			this.pnMenu.Rows.AddRange(new DevExpress.Utils.Layout.TablePanelRow[] {
            new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.AutoSize, 26F)});
			this.pnMenu.Size = new System.Drawing.Size(884, 60);
			this.pnMenu.TabIndex = 3;
			// 
			// btIsSklad
			// 
			this.pnMenu.SetColumn(this.btIsSklad, 0);
			this.btIsSklad.ImageOptions.Image = global::SC.Budget.Properties.Resources.sklad_icon;
			...
			this.pnMenu.SetRow(this.btIsSklad, 0);
			...
			// btIsNoMyOnly
			// 
			this.pnMenu.SetColumn(this.btIsNoMyOnly, 2);
			this.btIsNoMyOnly.ImageOptions.Image = global::SC.Budget.Properties.Resources.noMy;
			...
			this.pnMenu.SetRow(this.btIsNoMyOnly, 0);
			...
			// btIsAll
			// 
			this.pnMenu.SetColumn(this.btIsAll, 3);
			this.btIsAll.ImageOptions.Image = global::SC.Budget.Properties.Resources.НетФильтра;
			...
			this.pnMenu.SetRow(this.btIsAll, 0);
			...
			this.pnMenu.SetColumn(this.btIsMyOnly, 1);
			this.btIsMyOnly.ImageOptions.Image = global::SC.Budget.Properties.Resources.my;
			...
			this.pnMenu.SetRow(this.btIsMyOnly, 0);
			...
			// 
			this.objectProjectTreeBindingSource.DataSource = typeof(SC.Budget.Models.ObjectProjectTree);
			// 
			// treeMain
			// 
		...
		private DevExpress.Utils.Layout.TablePanel pnMenu;
