...
{
	partial class FrmNewOrEditStDoho
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmNewOrEditStDoho));
			...
			this.Name = "FrmNewOrEditStDoho";
			this.Text = "Новая статья дохода";
